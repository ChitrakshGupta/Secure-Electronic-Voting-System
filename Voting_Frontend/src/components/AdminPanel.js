...
function AdminPanel({ token, onLogout }) {
  ...
  const [voterData, setVoterData] = useState({ username: "", password: "" });
  ...
  const [editData, setEditData] = useState({ username: "", password: "", photo: null });
  ...
  const handleAddVoter = async () => {
    ...
    formData.append("password", voterData.password);
    ...
    try {
      ...
      setVoterData({ username: "", password: "" });
      setPhoto(null);
      fetchVoters();
    } catch (error) {
        ...
        return (
          <div className="admin-section">
            ...
            <button
              ...
              disabled={isVotingActive || loading} // Disable during loading
            >
            ...
            <ul className="admin-list">
              {voters.map((voter) => (
                <li key={voter.id} className="admin-list-item">
                  ...
                  />
                  <span className="admin-list-name">{voter.username}</span>
                  {editVoter === voter.id ? (
                    <div className="admin-edit-controls">
                      ...
                      <button className="admin-button save" onClick={() => handleUpdateVoter(voter.id)}>
                        Save
                      </button>
                      <button className="admin-button cancel" onClick={() => setEditVoter(null)}>
                        Cancel
                      </button>
                    </div>
                    </div>
